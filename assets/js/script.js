  ...
  (function () {
    ...
    var buildLegalBodyHtml = function (documentType) {
      ...
      return [
        ...
        "<li>If you have any questions regarding privacy, please review our Privacy Policy at <a href='" + legalPrivacyPolicyUrl + "' target='_blank' rel='noopener noreferrer'>" + legalPrivacyPolicyUrl + "</a>.</li>",
        "</ol>",
        "<h4>Sharing</h4>",
